...
import Services from '../Home/Banner/Services';
const About = () => {
    return (
        <div className="about-section">
            ...
            <div className="container">
             ...
             <h1 className="service-title text-white text-center mb-5">MEET OUR
              STRONGEST TEAM</h1>
                <div className="row">
                  ...
                  <div className="col-lg-3">
                      ...
                      <div className="about-info text-center text-white">
                          ...
                          <p className="position">NUTRITIONIST</p>
                          <i class="fab fa-facebook"></i>
                          <i class="fab fa-instagram"></i>
                          <i class="fab fa-twitter"></i>
                      </div>
                  ...
                  <div className="col-lg-3">
                      ...
                      <div className="about-info text-center text-white">
                          ...
                          <p className="position">PERSONAL TRAINER</p>
                          <i class="fab fa-facebook"></i>
                          <i class="fab fa-instagram"></i>
                          <i class="fab fa-twitter"></i>
                      </div>
